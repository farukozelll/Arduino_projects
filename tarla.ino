...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=NJNL4YPWLJWR3KA5";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.                                   //Göndereceğimiz sıcaklık değişkeni
  veri += "&field1=";
